...
Data are measured at 99  sampling stations by LUBW (Landesanstalt für Umwelt Baden-Wuerttemberg) equipped with 780 instruments for varioois atmospheric components. At some stations measurements started as early as 1976. Some typical stations have been selected for analysis of immissions and interaction of constituents. Data can be downloaded from  url:"https://https://udo.lubw.baden-wuerttemberg.de/public". Some missing data have been included from 2 stations operated by the city of Stuttgart "Amt für Umweltschutz".
