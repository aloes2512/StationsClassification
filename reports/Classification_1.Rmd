...
-- humidity  
and their interdependence. The data are time series measured at various sampling stations. 
...
Data are measured at 99  sampling stations by LUBW (Landesanstalt für Umwelt Baden-Wuerttemberg) equipped with 780 instruments. Measurements at some stations started as early as 1976.  From these some typical stations have been selected for analysis. Data can be downloaded from this url "https://https://udo.lubw.baden-wuerttemberg.de/public" In addition data from 2 stations operated by the city of Stuttgart "Amt für Umweltschutz" have been included.
...
As example of NO2 1-h mean values, measured at Stuttgart- Bad Cannstatt at the roadside are shown in the plot "NO2-immissions 20 years". The data exhibit a systematic trend but are poised by various errors as illustrated with the dots (each representing a  1- h mean) plotted together with red linear regression line over 20 years indicating a mean reduction.There is also a systematic annual variation with high values during winter time and low values during the summer month:

![Stg_Can](./figs/NO2_trend_20_years_Can.png)

 The plot suggests some systematic causes:  
--  the immissions vary annually with maximum in winter month
--  average immissions show are  reduced at a rate of $0.4 [μg/m^3]per year$
--  outliers indicate a strong variation of the immissions or instability of the instruments
...
Selecting a typical NO2- sampling station located in *rural environment (Schwarzwald Süd)* , a second measuring in *urban background (Stuttgart Bad-Cannstatt)* and a third at roadside of a *main street (Ludwigsburg Friedrichstrasse)* shows the different trends (slope) of averaged immission. 
