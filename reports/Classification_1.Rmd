...
The objective of this study is to understand the systematic dependence of the concentrations of some atmospheric gases on main variables as the emissions from various sources as motor vehicles, power-plants, industrial processes and the variation of environmental parameters as temperature, solar irradiation, humidity and their interdependence. The data are time series measured at various sampling stations. 
...
Data are measured with 99  sampling stations by LUBW (Landesanstalt für Umwelt Baden-Wuerttemberg) equipped with 780 instruments.Measurements at some stations started as early as 1976. From these some typical stations have been selected for analysis. Data can be downloaded from this url "https://https://udo.lubw.baden-wuerttemberg.de/public" In addition data from 2 stations operated by the city of Stuttgart "Amt für Umweltschutz" have been included.
...
-- average immissions show a ling term trend with  reduction of about $0.4 [μg/m^3]per year$
-- there are long periods without zero 1-h measurements (2016 to 2018) and others reaching zero over longer time periods(2001)
--  outliers indicate a strong variation of the immissions at the location of the sampling instrument which may be caused also by instability of the instruments
...
Selecting a typical NO2- sampling station located in *rural environment (Schwarzwald Süd)* , a second measuring in *urban background (Stuttgart Bad-Cannstatt)* and a third at roadside of a *main street (Ludwigsburg Friedrichstrasse)* shows the different trends of averaged immission. 
A reduction with a high rate at the station measuring traffic immissions, medium reduction rate at urban back ground and nearly invisible ate at rural back ground.
...
In Germany at temperatures lower than 15 C no heating is necessary.
