...
### Location  of selected sampling stations
 ...
 At some stations measurements started as early as 1976. Typical stations have been selected for analysis of immissions and interaction of constituents. Data can be downloaded from  url:"https://https://udo.lubw.baden-wuerttemberg.de/public". Some missing data have been included from 2 stations operated by the city of Stuttgart "Amt für Umweltschutz".
...
To cover the conditions of the varying air-quality:  --  3 sampling stations are located in rural environment,   
...
As example of NO2 1-h time series, measured at Stuttgart- Bad Cannstatt at urban background are shown in the plot "NO2-immissions 20 years". The data exhibit a systematic trend and  suggest periodic dependencies. The data are poised by stochastic effects as illustrated with the dots (each representing a  1- h mean). To determine systematic dependencies models need to be found to describe the measured 1-h data. A very simple model is the  red linear regression line calculated from 21 years measurements. It shows that the immissions did decrease. In addition an  annual variation with high values during winter time and low values during the summer month is suggested with the plot:
