...
3 sampling stations are located in rural environment,    7 stations located at main streets,    13 sampling urban background immissions.   The 2 stations operated by  the city of Stuttgart are located well above the street level. This has to be observed interpreting the data.   
...
![Stg_Hoh](./figs/NO2_trend_20_years_Stuttgart Hohenheimer Straße.png)

The following should be noted:    
-- the range of measurements covers only less than 17 years 2004-01-02 to 2021-10-01    
-- there are long period with zero 1-h measurements    
-- as will be seen later the reduction of immissions began 2010.
-- the rate of reductions per year was very different
-- there are strong outliers, which need interpretation 
-- variance of measurements changed with time
...
Mean values, variance and median of $NO_2$ and $O_3$ concentrations are very different for the 23 stations analyzed: 
...
## monthly trends show considerable variations

As example of smoothed values average NO2 immissions at Stuttgart Am Neckartor did increase from 2004 to 2005 with a sharp decrease following, which was interrupted in 2010 followed again by a strong decrease.
All urban sampling stations measured a strong reduction of immissions around 2015/2016. Some exceptions may be related to local actions as limiting the traffic to lower speeds or emissions from construction work, using heavy-duty machinery (new underground railway station __Stuttgart 21__). Which increased emissions and had an effect on the immissions at the nearby sampling station __Stg. Klettplatz__.
